...
void MainMenuState::ListenToEvent(Event * _event)
{
...
void MainMenuState::HandleInput(Input_KeyEvent* _keyEvent)
{
...
void MainMenuState::Enter()
{
	...
	m_menuHandler.LoadMainMenu(m_gui, m_fnt->GetResource(), m_sndMenu->GetResource(), m_sprCursor->GetResource());
}
...
void MainMenuState::Exit()
{
	...
	m_menuHandler.DeleteMainMenu(m_gui);
...
void MainMenuState::Update(float dt)
{
	...
	if (id == -1) {
		switch (lastid) {
		case 1:
			nextState = Globals::GameStates::STATE_PLAYING;
			break;
		case 2:
			nextState = Globals::GameStates::STATE_INSTRUCTIONSMENU;
			break;
		case 3:
			nextState = Globals::GameStates::STATE_CREDITSMENU;
			break;

		case 4:
			nextState = Globals::GameStates::STATE_EXIT;
			return;
...
void MainMenuState::UpdateBG(float dt)
{
	float tx, ty;
	static float t = 0.0f;
...
void MainMenuState::InitializeBG()
{
